...
import pages.TryPrime;

public class TryPrimeTest {
    ...
    @Test(priority =0)
    public void AmazonSignOutTest () throws InterruptedException{
        TryPrime tryPrime = new TryPrime(driver);
        tryPrime.TryPrimeHoverOver();
