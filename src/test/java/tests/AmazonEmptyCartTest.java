...
import pages.AmazonEmptyCart;


//public class LoginTest extends BaseTest{
public class AmazonEmptyCartTest {
    ...
    public void testHomeButton (){
        AmazonEmptyCart amazonEmptyCart = new AmazonEmptyCart(driver);
        
       amazonEmptyCart.amazonTestDeleteCart();
    }   
